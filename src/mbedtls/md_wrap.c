...
#include <AisinoSSL/mbedtls/config.h>
#else
...
#include <AisinoSSL/mbedtls/md_internal.h>

#if defined(MBEDTLS_MD2_C)
#include <AisinoSSL/mbedtls/md2.h>
#endif

#if defined(MBEDTLS_MD4_C)
#include <AisinoSSL/mbedtls/md4.h>
#endif

#if defined(MBEDTLS_MD5_C)
#include <AisinoSSL/mbedtls/md5.h>
#endif

#if defined(MBEDTLS_RIPEMD160_C)
#include <AisinoSSL/mbedtls/ripemd160.h>
#endif

#if defined(MBEDTLS_SHA1_C)
#include <AisinoSSL/mbedtls/sha1.h>
#endif
...
#include <AisinoSSL/mbedtls/sha512.h>
#endif
...
static void *sm3_ctx_alloc(void) {
    void *ctx = mbedtls_calloc(1, sizeof(sm3_context));
...
const mbedtls_md_info_t sm3_info = {
        MD_SM3,
        "SM3",
        32,
        64,
